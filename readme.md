...
* 유저는 리뷰 입력 화면에서 사진, 코멘트와 평점을 입력할 수 있습니다.

![리뷰 사진 등록](Documents/리뷰_사진_등록.png)
* 유저는 사진 이미지를 마우스로 클릭하면 원하는 이미지를 등록할 수 있습니다.

![리뷰 평점 입력](Documents/리뷰_평점_입력.png)
* 유저는 1점부터 5점까지 평점을 고를 수 있습니다.

![리뷰 등록 완료](Documents/리뷰_등록_완료.png)
* 사진 등록, 코멘트 입력과 평점을 입력하고 완료 버튼을 누르면 새로운 리뷰가 등록됩니다.
